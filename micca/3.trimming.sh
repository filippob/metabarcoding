...
do
	...
	$sickle_exe pe -f "${file}_R1_cutadapt.fastq.gz" -r "${file}_R2_cutadapt.fastq.gz" -o ${outdir}/trimmed/"${file}_trimmed_R1.fastq.gz" -p ${outdir}/trimmed/"${file}_trimmed_R2.fastq.gz" -s ${outdir}/trimmed/"${file}_singles.gz" -t sanger -q 20 -g 1>> ${outdir}/quality_control/stats_trim.txt
